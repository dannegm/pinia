...
export const ToggleIconButton = ({ active, onClick, label, activeColor, children }) => (
    <button
        type='button'
        aria-label={label}
        aria-pressed={active}
        ...
        className={cn(
            'flex-center size-8 rounded-md border transition-all duration-150 active:scale-90 [&>svg]:size-4',
            active
