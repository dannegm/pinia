...
export const PlaceForm = ({ initialCoords, initialValues, onSubmit, submitLabel, pending }) => {
    const { map } = useMap();
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className='flex h-full flex-col gap-3'>
                ...
                <Button type='submit' disabled={pending || categories.length === 0} className='mt-auto'>
                    {submitLabel}
                </Button>
            </form>
        </>
