...
export const CategoryFilterSelect = ({ selected, onToggle, onClear }) => {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
                ...
                render={
                    <button
                        ...
                        className={cn(
                            ...
                            {
                                'border-primary/40 bg-primary/5': selected.length > 0,
                                'border-border hover:bg-accent hover:text-accent-foreground': selected.length === 0,
                            },
                        )}
                    />
                }
            >
                <ListFilter
                    className={cn('size-4 shrink-0 text-foreground/50', { 'text-primary': selected.length > 0 })}
                />
